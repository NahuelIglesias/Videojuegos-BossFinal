...
var jumps_sound = load("res://assets/AUDIO EFFECT/JUMPS/slime_jump.wav")
var jumpController = AudioStreamPlayer2D.new() 
var jumps:int = 0
...
func enter():
	...
	jumpController.stream = jumps_sound
	jumpController.volume_db = 24
	jumpController.play()
	add_child(jumpController)
